...
function getRawEventData(googleKey, sheetId) {
    return __awaiter(this, void 0, void 0, function () {
        var SHEET_VALUE_URL, resp, raw;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    SHEET_VALUE_URL = "https://sheets.googleapis.com/v4/spreadsheets/" + sheetId + "/values/Schedule?key=" + googleKey;
...
function fetchEventsAndGroupings(googleKey, sheetId, hideFutureVenue) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getRawEventData(googleKey, sheetId)];
                case 1:
                    data = _c.sent();
...
function fetchLinkedInProfiles(googleKey, sheetId) {
    return __awaiter(this, void 0, void 0, function () {
        var data, linkedInProfileByName, _a, rawHeader, rawRows;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getRawLinkedInData(googleKey, sheetId)];
                case 1:
                    data = _b.sent();
...
;
function getRawLinkedInData(googleKey, sheetId) {
    return __awaiter(this, void 0, void 0, function () {
        var SHEET_VALUE_URL, resp, raw;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    SHEET_VALUE_URL = "https://sheets.googleapis.com/v4/spreadsheets/" + sheetId + "/values/Profiles?key=" + googleKey;
                    return [4 /*yield*/, fetch(SHEET_VALUE_URL, {
                            method: 'GET',
                            cache: 'default'
                        })];
